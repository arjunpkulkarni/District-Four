              ...
              <div className="flex flex-col md:flex-row items-start gap-8 p-6">
                ...
                <div className="w-full md:w-1/3 text-center flex-shrink-0 flex flex-col items-center">
                  ...
                  <div className="relative mb-6">
                    <div className="w-24 h-24 mx-auto rounded-full overflow-hidden ring-4 ring-gray-100 group-hover:ring-blue-600/20 transition-all duration-300">
                      <img
                        src={creator.image}
                        alt={creator.name}
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex justify-center gap-2">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full font-semibold text-sm transition-all duration-300 hover:shadow-lg"
                      ...
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="inline-flex items-center justify-center gap-2 bg-white hover:bg-blue-50 text-gray-700 border border-gray-300 px-4 py-2 rounded-full font-semibold text-sm transition-all duration-300 hover:shadow-lg hover:text-blue-600 hover:border-blue-600"
                ...
                <div className="w-full md:w-2/3">
                  {creator.statsImages && creator.statsImages.length > 0 && (
                    <div className="text-left">
                      <h4 className="font-semibold text-gray-800 mb-3 text-base">Work & Stats</h4>
                      <div className="grid grid-cols-4 gap-2">
                        {creator.statsImages.map((img, i) => (
                           <a key={i} href={img} target="_blank" rel="noopener noreferrer" className="block border border-gray-200 rounded-lg hover:border-blue-600 transition-colors overflow-hidden">
                            <img
                              src={img}
